...
export const dict = {
  id: {
    appTitle: "IDXAvg",
    appTagline: "Kalkulator averaging IDX",
    history: "Riwayat",
    clearHistory: "Hapus",
    ...
    positionTip: "Isi Avg Sekarang dan Total Lot dari posisi saham yang sedang kamu pegang.",
    avgNow: "Avg Sekarang (Rp)",
    totalLot: "Total Lot",
    modalAwal: "Modal Awal",
    averagingTitle: "Averaging",
    averagingTip: "Isi Lot Tambah untuk hitung avg baru, atau Target Avg untuk hitung lot yang dibutuhkan.",
    hargaAvg: "Harga Averaging (Rp)",
    lotTambah: "Lot Tambah",
    targetAvg: "Target Avg (Rp)",
    feeTitle: "Fee Beli/Jual",
    feeInclude: "Sertakan fee",
    feeBuy: "Fee Beli",
    feeSell: "Fee Jual",
    feeHint: "Default broker: beli 0.15% • jual 0.25%",
    hitung: "Hitung",
    fillHint: "Isi Lot Tambah atau Target Avg",
    avgBaru: "Avg Baru",
    ...
    feeBeliLabel: "Fee Beli",
    feeJualLabel: "Est. Fee Jual",
    breakEven: "Harga Break Even",
    hargaAveragingRow: "Harga Averaging",
    avgSekarangRow: "Avg Sekarang",
    copy: "Salin",
    share: "Salin link",
    savePng: "Simpan PNG",
    reset: "Reset",
